...
在[上一篇博客](http://ytliu.info/blog/2013/03/01/dr-android-and-mr-hide-xidashiyin-fa-de-gu-shi/)是一个用ruby和OCaml写的Dalvik binary rewriter，它提供了unparse, htmlunparse, id, combine, info, classes, api, opstat, cg, cfg, dom, pdom, dump_method等功能，还可以自己扩展相应的功能，具体的可以参看它的[github主页](https://github.com/plum-umd/redexer)。
...
![stackoverflowans](http://ytliu.info/images/2013-03-10-1.png "answer")
